...
import { Home, Hourglass, HeartPulse, Target, Notebook, MoonStar, BookOpen, Trophy, ListIcon, Podcast, ChevronLeft, ChevronRight, Moon, Sun, Menu, Expand, Minimize, Minimize2, Headphones, Maximize2, Languages, Shield, CircleDashed, Sunrise, Hand, Droplets, Sprout, HandHeart, Palmtree, MenuIcon, HelpCircleIcon, LogOut, Settings, User2 } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const items = [
    ...
    { label: 'Audio Library', icon: Headphones, href: '/bodcast' },
    { divider: true },
  ...
  return (
    <>
      ...
      <Modal title='Confirm Logout' show={showLogoutModal} onClose={() => setShowLogoutModal(false)}>
        <div className='space-y-4'>
          <p>Are you sure you want to log out?</p>
          <div className='flex justify-end gap-3'>
            <Button label="Cancel" onClick={()=> setShowLogoutModal(false)} color='white'   /> 
